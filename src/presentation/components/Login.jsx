  ...
  return (
    <>
      <div className="dropdown" style={{fontSize: (isHome? "18px": '15px'),}}>
        <button type="button" onClick={handleDropdown} className="headerLogin" style={{height: (isHome? "42px": '40px'), width: (isHome? "150px": '120px')}} ><big>Hi, Nguyễn{displayName}! </big> <sup style={{fontSize: (isHome? "15px": '12px')}}><i className="fa fa-sort-desc"  aria-hidden="true"></i></sup></button>
