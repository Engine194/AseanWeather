  ...
  return (
    <>
      <div className="dropdown" style={{fontSize: (isHome? "18px": '15px'),}}>
        <button type="button" onClick={handleDropdown} onBlur={handleDropdown} className="headerLogin" style={{height: (isHome? "42px": '40px'), width: (isHome? "150px": '120px')}} ><big>Hi, {displayName? displayName: "User"}! </big><span style={{fontSize: (isHome? "20px": '18px'), position: "relative", bottom: "5px", left: (isHome? "3px": '0px')}}><i className="fa fa-sort-desc"  aria-hidden="true"></i></span></button>
